...
class Solution:
    ...
    def dfs(self, arr, index, visited):
        ...
        return self.dfs(arr, index + arr[index], visited) or self.dfs(arr, index - arr[index], visited)
...
#space complexity: O(n) because in the worst case, we may have to store all indices in the visited set.
