...
#time complexity: O(n^2), where n is the length of the input array nums. We have two nested loops: the outer loop runs n times, and the inner loop also runs n times, resulting in O(n * n) = O(n^2).
