...
if __name__== "__main__":
    ...
    a.rotate(nums2, k2)
    print(nums2)  # Output: [3,99,-1,-100]
#time complexity: O(n), where n is the length of the input array nums. We reverse the entire array and then reverse two subarrays, each of which takes O(n) time in total.
